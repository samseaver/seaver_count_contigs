...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'seaver_count_contigs'):
...
impl_seaver_count_contigs = seaver_count_contigs(config)
...
async_run_methods = {}
async_check_methods = {}
async_run_methods['seaver_count_contigs.count_contigs_async'] = ['seaver_count_contigs', 'count_contigs']
async_check_methods['seaver_count_contigs.count_contigs_check'] = ['seaver_count_contigs', 'count_contigs']
sync_methods['seaver_count_contigs.count_contigs'] = True
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'seaver_count_contigs'
        ...
        self.rpc_service.add(impl_seaver_count_contigs.count_contigs,
                             name='seaver_count_contigs.count_contigs',
                             types=[basestring, basestring])
        self.method_authentication['seaver_count_contigs.count_contigs'] = 'required'
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "seaver_count_contigs but no authentication header was passed"
                            raise err
